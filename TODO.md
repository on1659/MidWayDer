...
## 완료된 버전 (v0.41.0 ~ v0.64.0)

### v0.64.0 - 성능 최적화 ✅ (2026-03-08)
- [x] 캐시 TTL 연장 (24시간 → 7일)
- [x] getCacheStats에 ttlDays 필드 추가
- [x] 766 tests passing
...
### v0.59.0 - 푸시 알림 ✅ (2026-03-08)
- [x] PWA 푸시 알림 구현
- [x] 알림 권한 요청 UI
- [x] 알림 구독 관리 (Prisma 모델)
- [x] 알림 전송 API
- [x] 750 tests passing
...
### v0.61.0 - 고급 기능 ✅ (2026-03-08)
- [x] 검색 필터 (이탈 거리: 500m, 1km, 2km, 5km)
- [x] 커스텀 카테고리 (localStorage 기반)
...
### v0.63.0 - UI 통합 ✅ (2026-03-08)
- [x] 메인 페이지에 "경로 저장" 버튼 추가 (이미 구현됨)
- [x] SearchOverlay에 저장된 경로 섹션 추가
- [x] QR 코드 공유 기능 활성화
- [x] 766 tests passing
